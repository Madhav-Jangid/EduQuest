      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              Revolutionizing education through AI-powered learning tools and personalized tutoring for students around the world.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">
            &copy; {currentYear} EduQuest. All rights reserved.
          </p>
          ...
          <div className="mt-4 md:mt-0 flex items-center text-gray-400">
            ...
            <span>By
              ...
              <a href="https://madhavjangid.vercel.app" target='_blank'> Madhav Jangid</a>
            </span>
          </div>
        </div>
      </div>
